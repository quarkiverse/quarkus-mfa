...
public class MFARouter {
    ...
    public String lookupTemplate(String templateName, String base) {
        ...
        InputStream is = Thread.currentThread().getContextClassLoader()
                .getResourceAsStream("/META-INF/resources/" + templateName);
        if (is != null) {
            try {
    ...
    private Handler<RoutingContext> template(String templateName, String base,
            BiFunction<String, RoutingContext, String> mapper) {
